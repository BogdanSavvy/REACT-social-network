	...
	return (
		<div className={`${style.users__member} ${style.member}`}>
			<div className={`${style.member__img}`}>
				<img
					src={props.bgImg != null ? props.bgImg : defaultBgImg}
					alt="BG_IMG"
				/>
			</div>
			<div className={`${style.member__ava}`}>
				<NavLink to={`/profile/${props.id}`}>
					<img
						src={props.ava != null ? props.ava : defaultUserPhoto}
						alt="AVATAR"
					/>
				</NavLink>
			</div>
			...
			<div className={`${style.member__actions}`}>
				{props.followed ? (
					<button
						disabled={isDisabled}
						onClick={onUnFollow}
						className={`${style.member__unFollow}`}
					>
					...
					<button
						disabled={isDisabled}
						onClick={onFollow}
						className={`${style.member__follow}`}
					>
						<FontAwesomeIcon icon={faUserCheck} /> Follow
					</button>
				)}
				<button className={`${style.member__message}`}>
