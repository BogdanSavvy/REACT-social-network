...
const NavBar = (props) => {
   ...
   let navOpen = () => {
      navEl.current.className === `${style.nav}` ? navEl.current.className =`${style.nav} ${style.nav_open}`
      : navEl.current.className =`${style.nav}`;
   };
      ...
      <nav ref={navEl} className={`${style.nav}`}>
         <ul className={`${style.nav__menuList}`}>
            <li className={`${style.nav__menuItem}`}>
               <NavLink className={`${style.nav__iconBox}`} to='/' style={({ isActive }) => {return {color: isActive ? "#0163cc" : "white",};}}>
                  <FontAwesomeIcon className={`${style.nav__icon}`} icon={faHouse} />
               </NavLink>
               <NavLink className={`${style.nav__link}`} to='/'> Home </NavLink>
            </li>
            <li className={`${style.nav__menuItem}`}>
               <NavLink className={`${style.nav__iconBox}`} to='/news' style={({ isActive }) => {return {color: isActive ? "#0163cc" : "white",};}}>
                  <FontAwesomeIcon className={`${style.nav__icon}`} icon={faNewspaper} />
               </NavLink>
               <NavLink className={`${style.nav__link}`} to='/news'> News </NavLink>
            </li>
            <li className={`${style.nav__menuItem}`}>
               <NavLink className={`${style.nav__iconBox}`} to='/messages' style={({ isActive }) => {return {color: isActive ? "#0163cc" : "white",};}}>
                  <FontAwesomeIcon className={`${style.nav__icon}`} icon={faEnvelope} />
               </NavLink>
               <NavLink className={`${style.nav__link}`} to='/messages'> Messages </NavLink>
            </li>
            <li className={`${style.nav__menuItem}`}>
               <NavLink className={`${style.nav__iconBox}`} to='/music' style={({ isActive }) => {return {color: isActive ? "#0163cc" : "white",};}}>
                  <FontAwesomeIcon className={`${style.nav__icon}`} icon={faMusic} />
               </NavLink>
               <NavLink className={`${style.nav__link}`} to='/music'> Music </NavLink>
            </li>
            <li className={`${style.nav__menuItem}`}>
               <NavLink className={`${style.nav__iconBox}`} to='/groups' style={({ isActive }) => {return {color: isActive ? "#0163cc" : "white",};}}>
